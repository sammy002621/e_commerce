...
function Pricing() {
  return (
    <div className='mx-5   flex flex-col lg:flex-row lg:justify-between 2xl:mx-80 lg:items-baseline text-center mt-20 mb-20 lg:flex md:grid md:grid-cols-2 md:gap-x-4 lg:mx-10  '>
