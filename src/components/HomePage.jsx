...
<div className='flex '>
               <div className=' w-full xl:w-auto flex flex-col  pt-9 md:grid md:grid-cols-2 md:gap-x-5 md:mx-5   2xl:flex 2xl:flex-row  xl:grid xl:grid-cols-5 xl:gap-x-80  xl:gap-y-2  2xl:gap-x-10 xl:overflow-auto '>
               <div className='mb-5  '>
