...
function About() {
  return (
    <div>
      <Header/>
      <HeaderHome/>
      <div className='flex mx-5 lg:mx-10 2xl:mx-60 lg:mt-20 mt-10 mb-10 2xl:px-12 '>
        ...
        <div className='flex 2xl:mx-60 lg:items-center lg:justify-between xl:mx-9 2xl:px-10  '>
