    ...
    <div>
        ...
        <div>
            ...
            <div className='mt-10 mx-5 xl:flex xl:items-center xl:mx-20 xl:justify-between'>
                ...
                <div className='hidden xl:inline xl:px-10 xl:py-3 xl:rounded-md xl:border xl:border-gray-100'><button>Move All To Blog</button></div>
            </div>

            {/* just for you */}
            <div className='flex mx-5 '>
               <div className='w-full xl:w-auto flex flex-col  pt-9 md:grid md:grid-cols-2  md:mx-10 md:gap-x-5   2xl:flex 2xl:flex-row  xl:grid xl:grid-cols-3  xl:gap-y-2 xl:gap-x-8 xl:mx-16 2xl:gap-x-5 '>
               <div className='mb-5 '>
